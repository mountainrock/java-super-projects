...
public abstract class PropertyLoader {
	 ...
	 * segment separation with an optional leading "/" and optional ".properties" suffix. Thus, the following names refer to the same resource:
	 * 
	 * <pre>
	 * some.pkg.Resource
	...
	{
		return loadProperties(name, Thread.currentThread().getContextClassLoader().getSystemClassLoader());
	}

	public static void main(String[] args)
	{
		String fileLocation = "D:/OSS/POC_LATEST/developer-pack/jmstest/jndi.properties";
