...
public class VelocityTemplateApply {
	...
	public static void main(String[] args) throws Exception
	{
		...
		String matchFldsISRCTN[] = { "Source of record", "ISRCTN", "Link to record in ISRCTN Register", "Date ISRCTN assigned", "Date applied", "Date updated", "NIH identifier",
				"Date last extracted from ISRCTN register", "Public title", "Scientific title", "Acronym", "Local reference number(s)", "Design/methodology", "Study hypothesis", "Ethics approval",
				"Countries of recruitment", "Disease/condition/study domain", "Participants - inclusion criteria", "Participants - exclusion criteria", "Patient information material",
				"Anticipated start date", "Anticipated end date", "Status of trial", "Target number of participants", "Interventions", "Primary outcome measure(s)", "Secondary outcome measure(s)",
				"Source of funding", "Publications", "Sponsor name", "Sponsor details", "Sponsor telephone", "Sponsor fax", "Sponsor email", "Sponsor website", "Contact name", "Contact details",
		...
		for (int i = 0; i < genericFlds.length; i++) {
			...
			context.put("matchFieldTitle", matchFldsISRCTN[i]);
